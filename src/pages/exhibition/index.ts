...
let $menu = $id("menu") as HTMLUListElement;

setMenu1(menus, $menu);

function setMenu1(menus: MENU[], $menu: HTMLUListElement) {
	menus.forEach(menu1 => {
		let li = $add("li");
...
function setMenu2(menus: { title: string; menu?: { title: string; }[] | undefined; }[], parentNode: HTMLUListElement) {
	menus.forEach(menu2 => {
		let li = $add("li");
...
function setMenu3(menus: { title: string; }[], parentNode: HTMLUListElement) {
	menus.forEach(menu3 => {
		let li = $add("li");
