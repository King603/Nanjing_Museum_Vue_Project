...
createLi(menu2, "menu2", function (menus) { return createLi(menus, "menu3"); });
...
function createLi(option, className, callBack) {
    option.menu.forEach(function (menu) {
