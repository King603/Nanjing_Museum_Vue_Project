      ...
      <div class="main_r">
        <div class="position">
          <div style="float: left; margin-top: 15px; margin-left: 20px">
            当前位置：<router-link to="" title="">首页</router-link>&gt;
        ...
        <div class="main_content">
          <div class="content_czyd">
            <div class="list_list" v-for="(li, i) of list" :key="i">
              <router-link :to="li.src">
                <div class="list_l">
                  <dt>
                    {{ li.name }}
...
export default {
  ...
  created() {
    axios({ method: "GET", url: "academic_research.json" }).then((res) => {
      ...
      for (
        let i = 0;
        i < this.size && i < this.info.length && (this.list[i] = this.info[i]);
        i++
      );
    });
  },
